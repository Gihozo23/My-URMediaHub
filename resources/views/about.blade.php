...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-headertwo">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">URMediaHub is an innovative and inclusive website designed to serve as a central hub for showcasing various aspects of student life, opportunities and accomplishments at the University of Rwanda.</p>
